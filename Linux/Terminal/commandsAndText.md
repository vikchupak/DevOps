...
_There is no text selecting without a mouse in linux terminal. And so `Ctrl + Shift + C` not possible without a mouse. Even selected text cannot be deleted at once._
